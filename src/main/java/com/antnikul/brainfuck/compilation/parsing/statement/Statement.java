...
public abstract class Statement {
    ...
    /**
     * Exports the statement using given {@code codeGenerator} and returns a code snippet corresponding to the statement
     * functionality but written in a different programming language.
     *
     * @param codeGenerator a codeGenerator to convert statement to another programming language
