...
public abstract class Expression {
    ...
    /**
     * Exports the expression using given {@code codeGenerator} and returns a code snippet corresponding to the
     * expression functionality but written in a different programming language.
     *
     * @param codeGenerator an codeGenerator to convert expression to another programming language
     * @return a transpiled code snippet
     */
    public abstract String export(CodeGenerator codeGenerator);
}
